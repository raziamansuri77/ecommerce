...
export default function Parent(props) {
  ...
  return (
    <div className="  ">
      <div className="text-center text-[30px] font-bold pt-4">
        Fiction Books
      </div>
      <img
        src="./public/bestsellerheading.jpg "
        alt=""
        ...
        <div className=" w-full ">
          ...
          <div className="grid grid-cols-6 gap-8 py-4 ">
            {displayedBooks.map((book) => (
              ...
              >
                <div className="bg-[#FD0000] rounded-full w-[40px] h-[40px] text-white text-[12px]  py-[1px] absolute -top-6 -right-4 flex items-center justify-center text-center">
                  {book.discountAmount}
                </div>
                <div className="flex flex-col items-center">
                  <img
